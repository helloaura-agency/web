...
export function Services() {
  ...
  return (
    <section id="services" title="Services" className="py-24 bg-gradient-to-b from-black to-gray-900 dark:from-black dark:to-gray-900 light:from-white light:to-gray-50 relative overflow-hidden transition-colors duration-300">
      {/* Background elements */}
